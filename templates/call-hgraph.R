...
)<%= if (input$plotTitle != "" & input$title.position=="top left-aligned") paste0(" +\n  ggplot2::labs(title = \"", input$plotTitle, "\") +\n  ggplot2::theme(plot.title = ggplot2::element_text(size = ", input$title.textsize, ", hjust = 0))") %><%= if (input$plotTitle != "" & input$title.position=="top center-aligned") paste0(" +\n  ggplot2::labs(title = \"", input$plotTitle, "\") +\n  ggplot2::theme(plot.title = ggplot2::element_text(size = ", input$title.textsize, ", hjust = 0.5))") %><%= if (input$plotTitle != "" & input$title.position=="top right-aligned") paste0(" +\n  ggplot2::labs(title = \"", input$plotTitle, "\") +\n  ggplot2::theme(plot.title = ggplot2::element_text(size = ", input$title.textsize, ", hjust = 1))") %><%= if (input$plotTitle != "" & input$title.position=="bottom left-aligned") paste0(" +\n  ggplot2::labs(caption = \"", input$plotTitle, "\") +\n  ggplot2::theme(plot.caption = ggplot2::element_text(size = ", input$title.textsize, ", hjust = 0))") %><%= if (input$plotTitle != "" & input$title.position=="bottom center-aligned") paste0(" +\n  ggplot2::labs(caption = \"", input$plotTitle, "\") +\n  ggplot2::theme(plot.capiton = ggplot2::element_text(size = ", input$title.textsize, ", hjust = 0.5))") %><%= if (input$plotTitle != "" & input$title.position=="bottom right-aligned") paste0(" +\n  ggplot2::labs(caption = \"", input$plotTitle, "\") +\n  ggplot2::theme(plot.capiton = ggplot2::element_text(size = ", input$title.textsize, ", hjust = 1))") %>
